<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full"
                    src="{{ $userInfo && $userInfo->profilePath ? asset('storage/images/' . $userInfo->profilePath) : asset('images/default-avatar.png') }}"
                    alt="user photo">
            </button>
            <!-- Dropdown menu -->
            @if (Route::has('login'))
                            ...
                            <li>
                                @if (Auth::user()->role === 'resort')
                                    <a href="{{ route('resort.booking') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Booking</a>
                                @endif
                            </li>
                            <li>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Blogs</a>
                </li>
                <li>
                    <a href="#"
    ...
    <div id="mobile-menu"
        class="fixed bottom-0 left-0 z-50 flex w-full items-center justify-around bg-white p-2 shadow-md md:hidden">
        ...
        <a href="#" class="text-gray-600 text-center">
            ...
            <span class="block text-xs">Events</span>
        </a>
        <a href="#" class="text-gray-600 text-center">
            <i class="fas fa-address-book fa-lg"></i>
            <span class="block text-xs">Blogs</span>
        </a>
        <a href="#" class="text-gray-600 text-center">
            <i class="fas fa-info-circle fa-lg"></i>
            <span class="block text-xs">About Us</span>
        </a>
